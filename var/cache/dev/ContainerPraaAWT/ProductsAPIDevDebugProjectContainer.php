 ...
 */
class ProductsAPIDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'ProductsAPI\\Controller\\ProductController' => 'getProductControllerService.php',
    ...
    {
        switch ($name) {
            case 'kernel.root_dir': $value = ($this->targetDirs[3].'/src/ProductsAPI'); break;
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/ProductsAPIDevDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'ProductsAPI',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'WebServerBundle' => 'Symfony\\Bundle\\WebServerBundle\\WebServerBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ProductsAPIDevDebugProjectContainer',
            ...
            'router.cache_class_prefix' => 'ProductsAPIDevDebugProjectContainer',
