 ...
 */
class ProductsDevDebugProjectContainer extends Container
{
    ...
    {
        switch ($name) {
            case 'kernel.root_dir': $value = ($this->targetDirs[3].'/src/Products'); break;
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/ProductsDevDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'ProductsDevDebugProjectContainer',
            ...
            'router.cache_class_prefix' => 'ProductsDevDebugProjectContainer',
